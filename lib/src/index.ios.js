...
export default class NotificationsIOS {
  static jsInitialised() {
    NativeRNNotifications.jsInitialised();
  }
  /**
  ...
  static async getInitialNotification() {
    ...
    if (notification) {
      notificationResponse.notification = notification.payload ? new IOSNotification(notification.payload) : new IOSNotification(notification);
      notificationResponse.action = notification.action;
      notificationResponse.identifier = notification.identifier;
  ...
  static requestPermissionsWithPromise() {
    return NativeRNNotifications.requestPermissions();
  }
